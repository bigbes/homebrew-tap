class SphinxIntlAT232 < Formula
  include Language::Python::Virtualenv

  desc "Tool to create intelligent and beautiful documentation"
  homepage "https://github.com/sphinx-doc/sphinx-intl"
  url "https://files.pythonhosted.org/packages/7a/21/eb12016ecb0b52861762b0d227dff75622988f238776a5ee4c75bade507e/sphinx_intl-2.3.2.tar.gz"
  sha256 "04b0d8ea04d111a7ba278b17b7b3fe9625c58b6f8ffb78bb8a1dd1288d88c1c7"
  ...
  test do
    ...
    # software. Run the test with `brew test sphinx_intl`. Options passed
